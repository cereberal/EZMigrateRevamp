...
namespace IdentityServerDAL.Migrations.IdentityServer.ConfigurationDb
{
    public partial class InitialConfigurationDbMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 4, 8, 14, 25, 11, 800, DateTimeKind.Utc).AddTicks(7689), null, "My Web API", true, null, "web_api", false, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2592000, 3600, 0, false, true, false, true, false, false, 300, true, null, "client_", "EZM", "EZM Client", null, null, new DateTime(2020, 4, 8, 14, 25, 11, 806, DateTimeKind.Utc).AddTicks(5370), null, 300, true, true, true, null, 300, false, null, null, false, null, "oidc", 1, 1, true, true, true, 1296000, false, null, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 4, 8, 14, 25, 11, 805, DateTimeKind.Utc).AddTicks(6276), null, "Your user identifier", false, true, "openid", false, true, true, null },
                    { 2, new DateTime(2020, 4, 8, 14, 25, 11, 805, DateTimeKind.Utc).AddTicks(8792), "Your user profile information (first name, last name, etc.)", "User profile", true, true, "profile", false, false, true, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2020, 4, 8, 14, 25, 11, 808, DateTimeKind.Utc).AddTicks(1841), null, null, "SharedSecret", "K7gNU3sdo+OL0wNhqoVWhr3g6s1xYv72ol/pe/Unols=" });
