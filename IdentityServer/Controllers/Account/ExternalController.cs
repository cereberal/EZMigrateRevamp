...
namespace IdentityServer
{
    ...
    public class ExternalController : Controller
    {
        ...
        private readonly UserManager<EMUsers> _userManager;
        private readonly SignInManager<EMUsers> _signInManager;

        public ExternalController(
             UserManager<EMUsers> userManager,
             SignInManager<EMUsers> signInManager,
        ...
        private async Task<(EMUsers user, string provider, string providerUserId, IEnumerable<Claim> claims)> FindUserFromExternalProviderAsync(AuthenticateResult result)
        {
        ...
        private async Task<EMUsers> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
